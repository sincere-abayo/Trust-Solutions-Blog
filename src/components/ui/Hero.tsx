...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-primary text-white overflow-visible">
      ...
      <div className="relative w-full max-w-7xl mx-auto flex flex-col justify-center items-center px-6 sm:px-8 md:px-10 lg:px-12 py-12 sm:py-16 md:py-20 lg:py-24 z-30">
        {/* Trust Badge */}
        ...
        <div className="text-center flex flex-col justify-center items-center mb-10 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-balance mb-6 sm:mb-8 md:mb-10 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200 hover:scale-105 transition-transform duration-500">
            Empowering Your Vision, Together.
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-slate-200 max-w-4xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 hover:text-white transition-colors duration-300 hover:scale-105">
            <span className="block sm:inline">
              Strategic Business Consulting, IT consulting, Real Estate
              Brokerage, and Event Planning, catering & Management.
            </span>
        ...
        <div className="flex flex-wrap gap-6 justify-center items-center w-full max-w-2xl">
          <button className="px-6 py-3 bg-secondary text-white rounded-lg shadow-lg hover:bg-secondary-dark transition-colors duration-300">
            Learn More
          </button>
          <button className="px-6 py-3 bg-accent text-white rounded-lg shadow-lg hover:bg-accent-dark transition-colors duration-300">
            Get Started
          </button>
        </div>
