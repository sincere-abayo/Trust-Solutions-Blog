...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-primary text-white overflow-visible">
      ...
      <div className="relative w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl mx-auto flex-1 flex flex-col justify-center items-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 py-8 sm:py-12 md:py-16 lg:py-20 z-30">
        {/* Trust Badge */}
