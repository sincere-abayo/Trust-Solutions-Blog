...
const AnimatedService = ({ text, delay }: { text: string; delay: number }) => {
  return (
    <span
    ...
    <>
          ...
          <div className="w-full text-center flex flex-col justify-center items-center mb-4 sm:mb-6 md:mb-8 lg:mb-10">
            ...
            <div className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-slate-200 max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 lg:mb-14 text-pretty leading-relaxed hover:text-white transition-colors duration-300">
              ...
              <div className="block space-y-2">
                ...
                <div className="block">
                  <AnimatedService text="• IT Consulting" delay={1200} />
                </div>
                <div className="block">
                  <AnimatedService
                    text="• Real Estate Brokerage"
                    delay={2000}
                  />
                </div>
                <div className="block">
                  <AnimatedService
                    text="• Event Planning, Catering & Management"
                    delay={2800}
                  />
                </div>
                <div className="block">
                  <AnimatedService text="• Digital Marketing" delay={3600} />
                </div>
              </div>
              {/* sub slogan */}
              <span className="block mt-3 sm:mt-1">
                One trusted partner for all your professional needs in Kigali
                and beyond.
              </span>
            </div>
            ...
            {/* Primary CTA */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 justify-center mb-6 sm:mb-8 md:mb-10 lg:mb-12 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
              <Link
                href="/contact"
                className="bg-accent text-primary px-5 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 md:py-5 rounded-xl font-black text-sm sm:text-lg md:text-xl lg:text-2xl hover:bg-white hover:text-black transition-all duration-500 shadow-xl hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 transform hover:scale-105 border-2 border-accent text-center"
              >
                GET STARTED
              </Link>
              <Link
                href="/about"
                className="bg-white/20 border-2 border-white text-white px-5 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 md:py-5 rounded-xl font-black text-sm sm:text-lg md:text-xl lg:text-2xl hover:bg-white hover:text-black transition-all duration-500 shadow-xl hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 transform hover:scale-105 text-center"
              >
                LEARN MORE
              </Link>
            </div>

            {/* Mobile Social Media Bar - Visible only on mobile/tablet */}
            <div className="lg:hidden w-full max-w-md mx-auto mb-6 sm:mb-8">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-5 border border-white/20 shadow-xl">
                <p className="text-white/90 text-xs sm:text-sm font-medium mb-3 text-center">
                  Connect with us
                </p>
                <div className="flex justify-center items-center gap-6 sm:gap-8">
                  <a
                    ...
                    className="text-white/80 hover:text-white transition-all duration-300 transform hover:scale-110 active:scale-95"
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
        ...
        <div className="relative p-2 sm:p-3">
          <Link
            href="/contact"
            className="pointer-events-auto block w-auto max-w-xs mx-auto bg-gray-900 text-blue-400 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl font-bold text-sm sm:text-base text-center shadow-[0_8px_32px_rgba(0,0,0,0.5)] hover:shadow-[0_12px_48px_rgba(59,130,246,0.5)] hover:bg-gray-800 hover:text-blue-300 transition-all duration-300 transform hover:scale-105 active:scale-95 border-2 border-blue-500/50 animate-pulse hover:animate-none ring-2 ring-blue-400/30"
          >
